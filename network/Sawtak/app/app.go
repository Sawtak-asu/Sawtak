...
import (
	...
	"github.com/sayedibrahimQ/sawtak/docs"
	poaante "github.com/sayedibrahimQ/sawtak/x/poa/ante"
	poakeeper "github.com/sayedibrahimQ/sawtak/x/poa/keeper"
	sawtakmodulekeeper "github.com/sayedibrahimQ/sawtak/x/sawtak/keeper"
)
...
type App struct {
	*runtime.App
	...
	SawtakKeeper sawtakmodulekeeper.Keeper
}
...
func New(
	...
	existingAnteHandler := app.AnteHandler()
	app.SetAnteHandler(func(ctx sdk.Context, tx sdk.Tx, simulate bool) (sdk.Context, error) {
		// Run default checks (including sig verification) first
		newCtx, err := existingAnteHandler(ctx, tx, simulate)
		if err != nil {
			return newCtx, err
		}
		// Then enforce PoA rules
		return poaDecorator.AnteHandle(newCtx, tx, simulate, func(c sdk.Context, t sdk.Tx, s bool) (sdk.Context, error) {
			return c, nil
		})
	})
