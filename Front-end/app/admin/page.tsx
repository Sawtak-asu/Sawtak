...
interface AdminFeedResponse {
    success: boolean;
    data?: {
        complaints: Complaint[]; // Reuse Complaint interface which now supports admin fields
        stats: {
            total: number;
            pending: number;
...
export default function AdminDashboard() {
    ...
    const { data, isLoading, isError, refetch } = useQuery({
        ...
        queryFn: async () => {
            ...
            params.set("limit", "12"); // Use grid friendly limit
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Manage complaints, update status, and review private submissions.
                            </p>
                        </div>
            ...
            <div className="container max-w-7xl mx-auto px-6 py-8">
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-8 p-4 bg-muted/30 rounded-xl border border-border/50">
                    <div className="relative flex-1">
                        ...
                        <Input
                            placeholder="Search by title, tracking code, or ID..."
                            value={search}
                ...
                {isLoading ? (
                    ...
                    <div className="text-center p-12 bg-red-500/5 rounded-xl border border-red-500/20">
                         ...
                         <h3 className="text-lg font-semibold text-red-500">Failed to load complaints</h3>
                         <p className="text-sm text-red-400">Please verify your connection and permissions.</p>
                    ...
                    <div className="text-center p-16 border border-dashed border-border rounded-xl">
                        ...
                        <p className="text-muted-foreground">Adjust filters to see more results.</p>
                    </div>
                ) : (
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
