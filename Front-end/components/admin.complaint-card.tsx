...
export function ComplaintCard({ complaint }: ComplaintCardProps) {
    ...
    const handleRequestReveal = async () => {
        ...
        try {
            const res = await fetch(apiUrl(`/api/admin/complaints/${encodeURIComponent(complaint.id)}/request-identity-reveal`), {
                method: "POST",
                headers: {
    ...
    useEffect(() => {
        ...
        const fetchHistory = async () => {
            ...
            try {
                const res = await fetch(apiUrl(`/api/admin/complaints/${encodeURIComponent(complaint.id)}/history`), {
